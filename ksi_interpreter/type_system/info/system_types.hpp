...
namespace ksi::interpreter {
  ...
  template <typename Type_config> inline system<Type_config>::ptr_type
  system<Type_config>::values::value_cat::get_type(ptr_system_types sys_types) const
  { return &sys_types->t_cat; }

  template <typename Type_config> inline system<Type_config>::ptr_type
  system<Type_config>::values::value_type::get_type(ptr_system_types sys_types) const
  { return &sys_types->t_type; }

  template <typename Type_config> inline system<Type_config>::ptr_type
  system<Type_config>::values::value_bool::get_type(ptr_system_types sys_types) const
  { return &sys_types->t_bool; }

  template <typename Type_config> inline system<Type_config>::ptr_type
  system<Type_config>::values::value_array::get_type(ptr_system_types sys_types) const
